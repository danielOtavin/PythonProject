...
class TestEmployeesPage:
    def test_view_update_delete_employee_ui(self, browser, clean_table_db, page_specific_admin_token, employee_api, admin_token,
                                         db_check_obj):
        ...
        employee_page = page_specific_admin_token('EmployeePage')
